...
const MESSAGES = {
  ca: {
    ...
    'empty.favorites.hint': 'Toca l’estrella d’una targeta per desar-la aquí i tenir-la a mà.',
  ...
  es: {
    ...
    'empty.favorites.hint': 'Toca la estrella de una tarjeta para guardarla aquí y tenerla a mano.',
  ...
  en: {
    ...
    'empty.favorites.hint': 'Tap the star on a card to keep it here.',
