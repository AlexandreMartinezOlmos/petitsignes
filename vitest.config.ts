...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
       ...
       * measures today (76.12% statements, 68.91% branches, 85.90% functions,
       * 77.24% lines), so it fails when coverage *drops* and never on the day
       ...
       * `sources.ts`: 78.28 / 72.48 / 87.34 / 79.33.
       */
      thresholds: {
        statements: 78,
        branches: 72,
